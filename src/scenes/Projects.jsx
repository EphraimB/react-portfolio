...
const Project = ({ title, image }) => {
    const overlayStyles = `absolute h-full w-full opacity-0 hover:opacity-90 transition-500 bg-grey z-30 flex flex-col justify-center items-center text-center p-16 text-deep-blue`;
        ...
        <section id="projects" className="pt-48 pb-48">
            ...
            <div className="flex justify-center">
                ...
                >
                    ...
                    <div
                        className="flex justify-center text-center items-center p-10 bg-blue max-w-[400px] max--[400px] text-2xl font-playfair font-semibold">
